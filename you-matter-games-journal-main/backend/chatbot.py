...
# Initialize LLM
def initialise_llm():
    groq_api_key = os.getenv('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')  # Load API Key from Environment Variable
    llm = ChatGroq(
        temperature=0,
        groq_api_key=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,
