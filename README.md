...
- 🤖 **AI Chatbot (24/7 Support)**  
  Provides empathetic conversations and mental health guidance anytime.

- 📓 **Journaling System**  
  Users can write and reflect on their thoughts and emotions securely.
...
- 🎮 **Wellness-Oriented Experience**  
  Designed to reduce stress and encourage healthy emotional habits.
...
- **Build Tool:** Vite  
- **Styling:** CSS  
- **AI Integration:** Chatbot-based interaction system  
